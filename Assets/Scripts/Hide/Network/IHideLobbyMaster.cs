...
namespace Hide.Network
{
    ...
    public interface IHideLobbyMaster
    {
        ...
        void OnFNLobbyMasterKnowledgeTransfer(IHideLobbyMaster previousLobbyMaster);
        /// <summary>
        ...
        void OnFNLobbyPlayerMessageReceived(IClientHidePlayer player, string message);
    }
}